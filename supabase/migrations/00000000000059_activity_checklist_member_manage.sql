-- Allow trip members to manage the full activity checklist from Home
-- (add / rename / reorder / delete / toggle), not only completion flags.
...
begin
  ...
  then
    raise exception 'Trip members may only update activity voting fields and checklists' using errcode = '42501';
  end if;
